...
GO
INSERT [dbo].[Products] ([ProductID], [ProductName], [Fabric], [ManufacturingYear], [Description], [Color], [Fit], [SleveLength], [Occasion], [PatternType], [Size], [Neck], [WashCare], [SoldBy], [Price], [Extension], [BrandID]) VALUES (2, N'Adidas Originals Men Navy Blue Firebird Track Solid Sporty Jacket', N'Polyester', N'January 2020', N'Mock collar, Regular fit is not tight and not loose, the perfect in-between fit, Long sleeves with ribbed cuffs, Zip pockets; Full zip; Ribbed hem, A trefoil logo, 3-Stripes down the sleeves', N'Navy Blue', N'Regular', N'Long Sleeves', N'Sports', N'Solid', N'Large', N'Mock Collar', N'Machine-wash', N'ADI SPORTS (INDIA) PVT. LTD.', N'$100', N'.jpg', 1)
GO
...
GO
INSERT [dbo].[Products] ([ProductID], [ProductName], [Fabric], [ManufacturingYear], [Description], [Color], [Fit], [SleveLength], [Occasion], [PatternType], [Size], [Neck], [WashCare], [SoldBy], [Price], [Extension], [BrandID]) VALUES (9, N'Men Red Printed Pullover Sweater', N'Cotton', N'January 2020', N'Red printed pullover sweater, has a round neck, long sleeves, and straight hem', N'Red', N'Regular', N'Long Sleeves', N'Casual', N'Printed', N'Medium', N'Round', N'Machine-wash', N'ARVIND LIFESTYLE BRANDS LTD.', N'$39', N'.jpg', 3)
GO
...
GO
INSERT [dbo].[ProductReviews] ([ReviewID], [Name], [Rating], [ReviewText], [ProductID], [ReviewDate]) VALUES (1, N'Rishi', 2, N'Great fitting with nice fabric', 1, CAST(N'2021-01-03T15:06:00.0000000' AS DateTime2))
GO
...
GO
INSERT [dbo].[Studios] ([StudioID], [Title], [StudioDesc], [PostDate], [Extension]) VALUES (2, N'Men Black Slim Fit Checked Formal Trousers', N'Casual to classic Chic! I alwasy pick key pieces that i can style at least three different ways. #MyntraSays #StayStlish #WesternLook #Classic #MenVdayLook', CAST(N'2020-12-08T14:27:00.0000000' AS DateTime2), N'.jpg')
GO
INSERT [dbo].[Studios] ([StudioID], [Title], [StudioDesc], [PostDate], [Extension]) VALUES (3, N'Men black & White Slim Fit Printed Formal Shirt', N'I know its super cool when you wear formals that match your style. #myntraspotlight #style #cool #Liveformal', CAST(N'2020-12-05T14:28:00.0000000' AS DateTime2), N'.jpg')
GO
